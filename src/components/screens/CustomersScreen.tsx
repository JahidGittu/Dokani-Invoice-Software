  ...
  return (
    <section className="p-4 sm:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-pos-surface-lowest rounded-xl p-5 border border-pos-surface-container">
          <div className="text-xs font-bold text-pos-on-surface-variant uppercase mb-2 flex items-center gap-1">{t('totalRevenue')} <InfoTooltip text="সব কাস্টমারের মোট বিক্রি।" /></div>
