...
const translations = {
  ...
  totalRevenue: { en: 'Total Sales', bn: 'মোট বিক্রি' },
  avgSpend: { en: 'Avg. Purchase', bn: 'গড় কেনাকাটা' },
  totalSpent: { en: 'Total Purchase', bn: 'মোট কেনাকাটা' },
  ...
  // Phase 2: Product fields
  barcode: { en: 'Barcode', bn: 'বারকোড' },
  categoryLabel: { en: 'Category', bn: 'ক্যাটাগরি' },
  brandLabel: { en: 'Brand', bn: 'ব্র্যান্ড' },
  buyRateLabel: { en: 'Buy Rate', bn: 'ক্রয় মূল্য' },
  salesRateLabel: { en: 'Sales Rate', bn: 'বিক্রয় মূল্য' },
  entries: { en: 'entries', bn: 'এন্ট্রি' },
  showing: { en: 'Showing', bn: 'দেখাচ্ছে' },

  // Phase 1: Sales fields
  carton: { en: 'Carton', bn: 'কার্টন' },
  pieceLabel: { en: 'Piece', bn: 'পিস' },
  sqftQty: { en: 'Sqft/Qty', bn: 'স্কয়ারফিট/পরিমাণ' },
  deliveryCharge: { en: 'Delivery', bn: 'ডেলিভারি' },
  returnLabel: { en: 'Return', bn: 'রিটার্ন' },
  lessLabel: { en: 'Less', bn: 'লেস' },
  payableLabel: { en: 'Payable', bn: 'প্রদেয়' },
  paidLabel: { en: 'Paid', bn: 'পরিশোধিত' },
  dueLabel: { en: 'Due', bn: 'বকেয়া' },
  balanceLabel: { en: 'Balance', bn: 'ব্যালেন্স' },
  previousDues: { en: 'Previous Dues', bn: 'পূর্ববর্তী বকেয়া' },
  dueInThisBill: { en: 'Due In This Bill', bn: 'এই বিলের বকেয়া' },
  labourLabel: { en: 'Labour', bn: 'লেবার' },
  remarkLabel: { en: 'Remark', bn: 'মন্তব্য' },
  modeLabel: { en: 'Mode', bn: 'মাধ্যম' },
  bank: { en: 'Bank', bn: 'ব্যাংক' },
  listed: { en: 'Listed', bn: 'তালিকাভুক্ত' },
  walking: { en: 'Walking', bn: 'ওয়াকিং' },
  complete: { en: 'Complete', bn: 'সম্পন্ন' },
  salesRate: { en: 'Sales Rate', bn: 'বিক্রয় দর' },
  add: { en: 'Add', bn: 'যোগ' },
  totalQty: { en: 'Total Quantity', bn: 'মোট পরিমাণ' },
  inWords: { en: 'In Word', bn: 'কথায়' },
  soldBy: { en: 'Sold By', bn: 'বিক্রেতা' },
  customerSignature: { en: 'Customer Signature', bn: 'ক্রেতার স্বাক্ষর' },
  authorizedSignature: { en: 'Authorized Signature', bn: 'অনুমোদিত স্বাক্ষর' },
  termsFooterBn: { en: 'Sold goods can be returned within 1 month. China/Indian goods cannot be returned.', bn: 'বিক্রিত মাল ১ মাসের মধ্যে ফেরত নেওয়া হয়।চায়না/ইন্ডিয়ান মাল ফেরত নেওয়া হয় না।' },
  ...
  addSupplier: { en: 'Add Supplier', bn: 'সরবরাহকারী যোগ করুন' },
  totalDue: { en: 'Total Due', bn: 'মোট বকেয়া' },
  purchaseSaved: { en: 'Purchase saved!', bn: 'ক্রয় সেভ হয়েছে!' },
  purchaseDeleted: { en: 'Purchase deleted!', bn: 'ক্রয় মুছে ফেলা হয়েছে!' },
  supplierAdded: { en: 'Supplier added!', bn: 'সরবরাহকারী যোগ হয়েছে!' },
  supplierDeleted: { en: 'Supplier deleted!', bn: 'সরবরাহকারী মুছে ফেলা হয়েছে!' },

  // Phase 5: Dashboard
  profile: { en: 'Profile', bn: 'প্রোফাইল' },
  salesTodayLabel: { en: 'Sales Today', bn: 'আজকের বিক্রয়' },
  cashTrxToday: { en: 'Cash Trx. Today', bn: 'নগদ লেনদেন আজ' },
  overallBalance: { en: 'Overall Balance', bn: 'সার্বিক ব্যালেন্স' },
  cashSales: { en: 'Cash Sales', bn: 'নগদ বিক্রয়' },
  duesSales: { en: 'Dues Sales', bn: 'বকেয়া বিক্রয়' },
  cashReceive: { en: 'Cash Receive', bn: 'নগদ গ্রহণ' },
  cashPayment: { en: 'Cash Payment', bn: 'নগদ প্রদান' },
  cashBalance: { en: 'Cash Balance', bn: 'নগদ ব্যালেন্স' },
  supplierDues: { en: 'Supplier Dues', bn: 'সরবরাহকারী বকেয়া' },
  customerDues: { en: 'Customer Dues', bn: 'কাস্টমার বকেয়া' },
  liability: { en: 'Liability', bn: 'দায়' },
  salesProgress: { en: 'Sales Progress', bn: 'বিক্রয় অগ্রগতি' },
  accountBalance: { en: 'Account Balance', bn: 'হিসাবের ব্যালেন্স' },
  account: { en: 'Account', bn: 'হিসাব' },

  // Phase 6: Reports
  purchaseReport: { en: 'Purchase Report', bn: 'ক্রয় রিপোর্ট' },
  salesReport: { en: 'Sales Report', bn: 'বিক্রয় রিপোর্ট' },
  stockReport: { en: 'Stock Report', bn: 'মজুদ রিপোর্ট' },
  paymentReport: { en: 'Payment Report', bn: 'পেমেন্ট রিপোর্ট' },
  customerReport: { en: 'Customer Report', bn: 'কাস্টমার রিপোর্ট' },
  supplierReport: { en: 'Supplier Report', bn: 'সরবরাহকারী রিপোর্ট' },
  profitReport: { en: 'Profit Report', bn: 'লাভ রিপোর্ট' },
  dueReport: { en: 'Due Reports', bn: 'বকেয়া রিপোর্ট' },
  fromDate: { en: 'From', bn: 'থেকে' },
  toDate: { en: 'To', bn: 'পর্যন্ত' },
  reportRange: { en: 'Report Range', bn: 'রিপোর্ট পরিসর' },
  listOfReports: { en: 'List of Reports', bn: 'রিপোর্ট তালিকা' },
